...
import starmeet.convergentmobile.com.starmeet.Fragments.MyAccountFragment;
...
public class MyAccountActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSelfMenuItem(R.id.my_account);
    ...
    protected void initViews2() {
        ...
        fr.beginTransaction().add(R.id.container, accountFragment, "MyAccountFragment").commit();
    }
