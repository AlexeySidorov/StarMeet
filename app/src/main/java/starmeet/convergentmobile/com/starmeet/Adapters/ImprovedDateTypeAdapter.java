...
public final class ImprovedDateTypeAdapter extends TypeAdapter<Date> {
    ...
    private final DateFormat isoCustomFormat;
    ...
    public ImprovedDateTypeAdapter() {
        ...
        this.isoCustomFormat = buildCustomFormat();
    }
    ...
    private static DateFormat buildCustomFormat() {
        DateFormat iso8601Format = new SimpleDateFormat(
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            return buildCustomFormat().parse(json);
