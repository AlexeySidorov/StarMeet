...
import starmeet.convergentmobile.com.starmeet.Fragments.CelebrityProfileFragment;
...
public class ProfileCelebrityActivity extends BaseActivity implements CallbackNotification {
    ...
    protected void initViews2() {
        ...
        CelebrityProfileFragment profileFragment = new CelebrityProfileFragment();
        fr.beginTransaction().add(R.id.container, profileFragment, "CelebrityProfileFragment").commit();
    }
