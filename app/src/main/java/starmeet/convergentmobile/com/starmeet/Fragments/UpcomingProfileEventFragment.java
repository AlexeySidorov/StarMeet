...
public class UpcomingProfileEventFragment extends Fragment implements Observer {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.event_upcoming_fragment, null);
    }
    ...
    private void initViews() {
        eventList = Objects.requireNonNull(getActivity()).findViewById(R.id.event_upcoming_list);
