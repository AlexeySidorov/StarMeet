...
public class UpcomingCelebrityProfileEventFragment extends Fragment implements AdapterClickListener<OrderModel> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.orders_celebrity_profile_fragment, null);
    }
