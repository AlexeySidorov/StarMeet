...
public class CustomQuestionDialog extends SupportBlurDialogFragment implements View.OnClickListener {
    ...
    private AppCompatButton secondButton;
    private AppCompatTextView contentDlg;

    public void setView(int resourceId, String title, String content, String firstButtonName, String secondButtonName) {
    ...
    private void initView(View view) {
        ...
        secondButton = view.findViewById(R.id.next_dialog_button);
    ...
    private void setContent() {
        ...
        firstButton.setText(firstButtonName);
        secondButton.setText(secondButtonName);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.next_dialog_button: {

                if (result != null)
                    result.onResult(DialogService.ButtonType.SecondButton);
